...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lzan13', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '慢慢来，一步一个脚印！👣', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://melove.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_HOME: process.env.NEXT_PUBLIC_CONTACT_HOME || '', // 首页地址
  ...
  PRISM_THEME_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PATH || 'https://npm.elemecdn.com/prism-themes/themes/prism-a11y-dark.min.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
  ...
  BACKGROUND_LIGHT: '#f5f6f7', // use hex value, don't forget '#' e.g #fffefc
  ...
  POST_PREVIEW_LINES: process.env.NEXT_PUBLIC_POST_PREVIEW_LINES || 4, // 预览文章内容行数
  POST_RECOMMEND_COUNT: process.env.NEXT_PUBLIC_POST_RECOMMEND_COUNT || 6, // 推荐文章数量
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POSTS_PER_PAGE || 12, // 每页文章数量
  POSTS_SORT_BY: process.env.NEXT_PUBLIC_POST_SORT_BY || 'notion', // 排序方式 'date'按时间,'notion'由notion控制

  PREVIEW_CATEGORY_COUNT: process.env.NEXT_PUBLIC_PREVIEW_CATEGORY_COUNT || 8, // 首页最多展示的分类数量，0为不限制
  PREVIEW_TAG_COUNT: process.env.NEXT_PUBLIC_PREVIEW_TAG_COUNT || 16, // 首页最多展示的标签数量，0为不限制
  ...
  WIDGET_PET_SWITCH_THEME: process.env.NEXT_PUBLIC_WIDGET_PET_CHANGE_THEME || false, // 点击宠物挂件切换博客主题
